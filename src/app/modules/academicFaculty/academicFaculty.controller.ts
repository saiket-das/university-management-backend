...
const getAllAcademicFaculties = async (req: Request, res: Response) => {
...
const getSingleAcademicFacultyById = async (req: Request, res: Response) => {
...
const updateAcademicFacultyById = async (req: Request, res: Response) => {
  const { facultyId } = req.params;
  const result = await AcademicFacultyServices.updateAcademicFacultyByIdService(
    facultyId,
    req.body,
  );
